...
const MiniPlayer = (props:any) => {
  ...
  const IVSPlayer:any = typeof window !== "undefined" ? window?.IVSPlayer : null;
  ...
  const updatePlayer = useCallback(
    (isMini) => {
      let top: string|number = DEFAULT_POSITION;
      let right: string|number = DEFAULT_POSITION;
      let bottom: string|number = DEFAULT_POSITION;
      let left: string|number = DEFAULT_POSITION;

      let targetPosition: string|number = 0;
  ...
  const { top, right, bottom, left } = playerPosition as any;
